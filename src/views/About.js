...
function About() {
  ...
  const fetchAboutItems = async () => {
    try {
      const response = await axios.get("http://localhost:3000/about/list");
  ...
  const addAboutItem = async () => {
    try {
      ...
      await axios.post("http://localhost:3000/about/add", newAboutItem);
      fetchAboutItems();
  ...
  const updateAboutItem = async () => {
    try {
      await axios.put(`http://localhost:3000/about/update/${editingAboutItem.id}`, editingAboutItem);
      fetchAboutItems();
  ...
  const deleteAboutItem = async (id) => {
    try {
      await axios.delete(`http://localhost:3000/about/delete/${id}`);
      fetchAboutItems();
    } catch (error) {
