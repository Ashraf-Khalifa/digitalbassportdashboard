...
function Background() {
  ...
  const fetchBackgrounds = async () => {
    try {
      const response = await axios.get("https://coral-app-harbz.ondigitalocean.app/background/list");
  ...
  const addBackground = async () => {
    try {
      ...
      await axios.post("https://coral-app-harbz.ondigitalocean.app/background/add", newBackground);
      fetchBackgrounds();
  ...
  const updateBackground = async () => {
    try {
      await axios.put(`https://coral-app-harbz.ondigitalocean.app/background/update/${editingBackground.id}`, editingBackground);
      fetchBackgrounds();
  ...
  const deleteBackground = async (id) => {
    try {
      await axios.delete(`https://coral-app-harbz.ondigitalocean.app/background/delete/${id}`);
      fetchBackgrounds();
    } catch (error) {
