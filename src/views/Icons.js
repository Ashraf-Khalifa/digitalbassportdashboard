...
function Icons() {
  ...
  const fetchIcons = async () => {
    try {
      const response = await axios.get("https://coral-app-harbz.ondigitalocean.app/icons/list");
  ...
  const addIcon = async () => {
    try {
      ...
      await axios.post("https://coral-app-harbz.ondigitalocean.app/icons/add", newIcon);
      fetchIcons();
  ...
  const updateIcon = async () => {
    try {
      await axios.put(`https://coral-app-harbz.ondigitalocean.app/icons/update/${editingIcon.id}`, editingIcon);
      fetchIcons();
      setEditingIcon(null);
    } catch (error) {
  ...
  const deleteIcon = async (id) => {
    try {
      await axios.delete(`https://coral-app-harbz.ondigitalocean.app/icons/delete/${id}`);
      fetchIcons();
    } catch (error) {
